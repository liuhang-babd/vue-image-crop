<template>
	<div class="vue-image-crop-upload" v-show="modelShow">
		<div class="vicp-wrap">
			<div class="vicp-close" @click="off">
				<i class="vicp-icon4"></i>
			</div>
			<!-- 关闭步骤一，待优化 -->
			<div class="vicp-step1" v-show="false">
				<div class="vicp-drop-area" @dragleave="preventDefault" @dragover="preventDefault"
					...
					<input type="file" accept="image/*" v-show="false" v-if="step == 1" @change="handleChange"
						ref="fileinput">
				</div>
			...
			<div class="vicp-step2" v-if="step == 2">
				<div class="vicp-crop">
					<div class="vicp-crop-left" v-show="true">
						<!-- <div class="vicp-img-container" @wheel.prevent="handleMouseWheel" style="containerStyle"> -->
						<div class="vicp-img-container" @wheel.prevent="handleMouseWheel" >
							...
							<!-- <div class="vicp-img-shade vicp-img-shade-circle"></div> -->
						</div>
			...
			<!-- 关闭步骤三，待优化 -->
			<div class="vicp-step3" v-if="false">
...
<script>
'use strict';
import language from '@/utils/js/language.js';
import mimes from '@/utils/js/mimes.js';
import data2blob from '@/utils/js/data2blob.js';
import effectRipple from '@/utils/js/effectRipple.js';
...
export default {
	...
	methods: {
		...
		upload() {
			...
			fmData.append(requestKey, data2blob(createImgUrl, mime), field + '.' + imgFormat);
	...
	mounted() {
		this.initImgFile(this.imgFile)
		// console.log("vue-image-crop-upload 文件下的file", this.imgFile)
